...
if __name__ == '__main__':
    N_Proces = 2
    ini, end = 0.0, 40.0; bista_ini, bista_end = 7,30
...
with open(os.path.join(PATH+'/data_1p/ifn_b_Ky_{}.dat'.format(Ky)), 'w') as f_series:           # Cross check which need to save
